...
def damier_de_boutons():
    ...
    while compteur_de_lettre < 25:
        for i in range(26):
            ...
            places_des_boutons.append(f"{lettres_de_lalphabet[compteur_de_lettre]}{numero_possible[i]}"+" se trouve à x : "f"{10+i * espace_multiplie_entre_boutons}"+"  y : "f"{10+ compteur_de_lignes * espace_multiplie_entre_boutons}")
